...
<html
    ...
    <head>
        ...
        <title>Med-Mate | Medicine Sell</title>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            %>
                            <div class="card">
                                <h5 class="card-header">Medicine Selling</h5>
                                <form action="editMedServlet?actionType=searchByName" method="POST">
                                    <input class="form-control w-50" name="medName" style="display:inline-block;margin-left: 2%;margin-bottom: 1%;" type="text" placeholder="Search medicine by Name"><br>
...
//                                                        if(medName != ""){
                                                        ...
                                                        ResultSet rs = mc.MedInfoByName(medName);
                                                        while (rs.next()) {
                                                    %>
                                                    <tr>
