...
public class addMedicine extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean status = mc.insertMedInfo(Med_Name, Ex_Date, Med_Type, Quantity, Cost_Price, Selling_Price);
            if(status){
                out.print("<script>alert(\""+Med_Name+" Saved.\");</script>");
            }
            else
                out.print("<script>alert(\""+Med_Name+" not Saved.\");</script>");
